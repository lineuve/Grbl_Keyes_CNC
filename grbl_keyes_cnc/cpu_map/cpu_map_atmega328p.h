...
/*
 * WARNING
 * THIS SOURCE CODE IS EDITED TO MATCH
 * THE SWAPPED DIR AND STEP PINS ON THE CHINESE
 * MOTOR DRIVERS
 * 
 * THEY ARE SWAPPED BETWEEN STEP AND DIRECTION FOR EACH AXIS
 */
...
#define STEPPERS_DISABLE_BIT    0  // Uno Digital Pin 8 - when it's 0
